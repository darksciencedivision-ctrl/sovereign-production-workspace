...
- JSON Schemas in `schemas/` are the single source of truth, frozen `@1.0`; every envelope pins its schema version.
...
override; (17) debate cost-governed (budget/quota/global cap); (18) no node solely judges
its own work.
