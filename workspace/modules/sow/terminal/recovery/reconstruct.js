 ...
 *
 * Folds the append-only SessionRegistry lifecycle log (invariant 12) — the authoritative record
 * of every supervised PTY and its state transitions — into the ordered view the shell rebuilds
